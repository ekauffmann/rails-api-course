class Api::V1::ReviewsController < ApplicationController
  ...
  def update
    ...
    if correct_user @review.user
      if @review.update review_params
        ...
        json_response 'Review update failed', false, {}, :unprocessable_entity
      end
    else
  ...
  def destroy
    ...
    if correct_user @review.user
      if @review.destroy
        ...
        json_response 'Review deletion failed', false, {}, :unprocessable_entity
      end
    else
      json_response 'You do not have permission to do this', false, {}, :unauthorized
    end
  ...
  def load_review
    ...
    unless @review.present?
      json_response 'Cannot get review', false, {}, :not_found
    end
  end
end